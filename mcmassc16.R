...
if(USER.DATA$name == 'admin'){
    cnd = gui.choose.item(c('recognition', 'recall'))
}else{
...
Należy zaznaczyć za pomocą myszki, przyciskając lewy klawisz, na ile dane słowo kojarzy się negatywnie, neutralnie lub pozytywnie.
...
} ## Jeżeli recall, to miało być odtwarzanie przez ileśtam minut, a potem ocena pewności
